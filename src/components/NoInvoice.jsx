...
function NoInvoice() {
  return (
    <aside className='flex flex-col items-center justify-center py-8 px-4 h-full  2xl:h-[500px]  3xl:h-[800px] w-full dark:text-custom-ligth-100 text-custom-dark-blue-400'>
